...
#   ADD_CUSTOM_TARGET(${WRAPPER_LIBRARY_NAME}Idx DEPENDS ${SWIG_INTERFACE_IDX_FILES})
  ...
  SET(typedefs_file "${WRAPPER_MASTER_INDEX_OUTPUT_DIR}/${WRAPPER_LIBRARY_NAME}.typedefs")
  SET(WRAP_ITK_FILE_CONTENT "${SWIG_INTERFACE_TYPEDEFS}")
  CONFIGURE_FILE("${WRAP_ITK_CONFIG_DIR}/empty.in" "${typedefs_file}"
    @ONLY IMMEDIATE )
